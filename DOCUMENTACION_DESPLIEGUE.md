...
Opciones), corrección que cuenta por lotes sin arranques ciegos, pantalla
completa diferenciada y Unir con blanco residual. Publicado como
`dpl_739sVhTz3FbshU6a31ngiMxMTc6B` (READY), alias `jg-turbo.vercel.app`.
Verificados marcadores (`v2.46.0`, `JG_JS_V=v86`, shell `v86`), SHA-256
(29 de 29 idénticos), `/api/health` 200 y recorridos contra producción. Un
solo despliegue para toda la tanda. Detalle: [CAMBIOS_PDF.md](CAMBIOS_PDF.md).
