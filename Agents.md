...
SW vigente: **`jg-turbo-shell-v91`** (resucitar un PDF borrado y vuelto a extraer, v2.50.0). PWA instalable en escritorio (Chrome/Edge) y móvil: ver `INSTALAR_ESCRITORIO.md`.
