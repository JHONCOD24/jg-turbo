...
SW vigente: **`jg-turbo-shell-v83`** (el teléfono desplaza el documento, UX v2.43.0). PWA instalable en escritorio (Chrome/Edge) y móvil: ver `INSTALAR_ESCRITORIO.md`.
