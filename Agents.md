...
SW vigente: **`jg-turbo-shell-v74`** (corrección completa de lectura y cierre del panel PDF, v2.36). PWA instalable en escritorio (Chrome/Edge) y móvil: ver `INSTALAR_ESCRITORIO.md`.
